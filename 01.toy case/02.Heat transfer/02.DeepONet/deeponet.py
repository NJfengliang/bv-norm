...
def train_net(device, data_path, epoch, batch_sizes, l_r, part):
    ...
    dataO = torch.tensor(Data['output_points'].astype(np.float32))
    ...
    net = dde.nn.pytorch.deeponet.DeepONetCartesianProd(
        [n_t, 512, 512, 128], [3, 512, 512, 512, 128, ], "relu", "Glorot normal"
    )
...
if __name__ == "__main__":
    ...
    for i in range(5):
        ...
        part = "heat_3_20000_qe3_07/" + str(i)  # composite_part.mat
