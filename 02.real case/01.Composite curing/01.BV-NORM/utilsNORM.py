...
class MeshNO(nn.Module):
    def __init__(self, modes, LBO_MATRIX, LBO_INVERSE, width):
        ...
        # self.conv4 = SpectralConv1d(self.width, self.width, self.modes1, self.LBO_MATRIX, self.LBO_INVERSE)
        # self.conv5 = SpectralConv1d(self.width, self.width, self.modes1, self.LBO_MATRIX, self.LBO_INVERSE)
        ...
        self.out = DoubleConv(3, self.modes1)
