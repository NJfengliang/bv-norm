...
if __name__ == '__main__':
    ...
    for i in range (n):
        ...
        data    = sio.loadmat(str(i) + '/MeshNO_pre.mat')
        y_train = data['y_train']
        y_test  = data['y_test']
        pre_train = data['pre_train']
        pre_test  = data['pre_test' ]
        
        Results[i, 0:4] = loss_func(y_test, pre_test)
        Results[i, 5:9] = loss_func(y_train, pre_train)
